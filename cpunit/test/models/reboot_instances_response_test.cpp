...
namespace RebootInstancesResponseTest {
  using namespace cpunit;
#define USTR CPUNIT_STR

  CPUNIT_TEST(RebootInstancesResponseTest, test0) {
    const std::string myxml;
    const model::reboot_instances_response resp(myxml);
