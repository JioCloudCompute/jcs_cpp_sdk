...
namespace TerminateInstancesResponseTest {
  using namespace cpunit;
#define USTR CPUNIT_STR

  CPUNIT_TEST(TerminateInstancesResponseTest, test0) {
    const std::string myxml;
    const model::terminate_instances_response resp(myxml);
