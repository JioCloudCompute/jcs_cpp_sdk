...
namespace UpdateDeleteOnTerminationResponseTest {
  using namespace cpunit;
#define USTR CPUNIT_STR

  CPUNIT_TEST(UpdateDeleteOnTerminationResponseTest, test0) {
    const std::string myxml;
    const model::update_delete_on_termination_flag_response resp(myxml);
  ...
  CPUNIT_TEST(UpdateDeleteOnTerminationResponseTest, test2) {
    const string myxml("<UpdateDeleteOnTerminationFlagResponse xmlns=\"https://compute.ind-west-1.jiocloudservices.com/doc/2016-03-01/\"><volume><instanceId>i-2476e7c7</instanceId><deleteOnTermination>true</deleteOnTermination><volumeId>34f0b870-c160-4d97-9df6-8456c7569786</volumeId></volume><requestId>req-722680ec-57a8-43ce-afc1-414720b0aaec</requestId></UpdateDeleteOnTerminationFlagResponse>");
    const model::update_delete_on_termination_flag_response resp(myxml);
