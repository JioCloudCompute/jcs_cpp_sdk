...
namespace StopInstancesResponseTest {
  using namespace cpunit;
#define USTR CPUNIT_STR

  CPUNIT_TEST(StopInstancesResponseTest, test0) {
    const std::string myxml;
    const model::stop_instances_response resp(myxml);
